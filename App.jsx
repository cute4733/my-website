    ...
    <div className="min-h-screen bg-[#FAF9F6] text-[#5C5555] font-sans">
      <style>{`
        ...
        .pattern-diagonal-lines-sm {
            background-image: repeating-linear-gradient(45deg, #fca5a5 0, #fca5a5 1px, transparent 0, transparent 50%);
