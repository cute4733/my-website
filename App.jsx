      ...
      <main className="pt-20">
        {activeTab === 'home' ? (
          <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-6 text-center">
            <span className="text-[#C29591] tracking-[0.6em] text-[10px] mb-8 uppercase font-light">Est. 2025 • Taipei</span>
              ...
              {filteredItems.map(item => (
                <div key={item.id} className="group flex flex-col bg-white border border-[#F0EDEA] shadow-sm">
                  ...
                  <div className="p-8 flex flex-col items-center text-center">
                    ...
                    <div className="flex items-center gap-1.5 text-gray-400 text-[11px] mb-4">
                      <Clock size={13} />
                      <span>預計：{item.duration || '90'} 分鐘</span>
                    </div>
                    ...
                    <div className="w-full mb-8 text-left">
                      ...
                      <select 
                        required 
                        className="w-full text-[11px] border border-[#EAE7E2] py-3 px-4 bg-[#FAF9F6] outline-none"
                        defaultValue=""
                      >
